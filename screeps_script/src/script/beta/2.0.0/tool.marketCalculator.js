...
(function(){
    ...
    */
    function calcBestResponseCommodityBasedOnExistence(stopResources = [],settings = {series:["biomass","mist","metal","silicon","compressed","basic"],stopArr:[],single:false,detectLevel:false,existenceBased:false,roomNames:[],storeObjects:[],findObjects:false}){
        stopResources = stopResources || [];
        _.defaults(settings,{series:["biomass","mist","metal","silicon","compressed","basic"],stopArr:[],single:false,detectLevel:false,existenceBased:false,roomNames:[],storeObjects:[],findObjects:false});
        ...
        for (const serie of settings.series) {
            ...
            for (const commodity of potentialCommodities) {
                ...
                if (expectedRevenue.revenue > bestCommodity.revenue) {
    ...
    // You can also use it in your script by "new" keyword.
    global.MarketCal = MC;
//  Game.MarketCal = MC;
