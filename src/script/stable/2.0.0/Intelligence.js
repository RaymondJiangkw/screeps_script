...
class Intelligence_task {
     ...
     * @param   {String|undefined}  from.targetRoom     The room where the target lies. undefined will be interpreted as the home of the working creep.
     ...
     * @param   {String|undefined}  to.targetRoom       The room where the target lies. undefined will be interpreted as the home of the working creep.
