    ...
    get: function(){
        if(this["_repairTargets"] && this["_repairTargets_ts"] === Game.time) return this["_repairTargets"]
            ...
            if (_ret.length > 0){
                ...
                return this["_repairTargets"] = _.map(_ret,Game.getObjectById).sort((a,b)=>a.hits/a.hitsMax - b.hits / b.hitsMax);
            }else{
                this["_repairTargets_ts"] = Game.time;
    ...
    get:function(){
        if (this["_ruins"] && this["_ruins_ts"] === Game.time){
            ...
            if (roomRuins[this.name].length > 0){
                ...
                return this["_ruins"] = _.map(roomRuins[this.name],Game.getObjectById).sort((a,b)=>b.store.getUsedCapacity() - a.store.getUsedCapacity());
            }else{
                this["_ruins_ts"] = Game.time;
                return this["_ruins"] = [];
            }
